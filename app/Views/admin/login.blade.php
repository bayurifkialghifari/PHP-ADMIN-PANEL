...
<html lang="{{ $website['web_language'] }}" id="extr-page">
	...
	<body class="animated fadeInDown">
		...
		<header id="header">
			...
			<div id="logo-group">
				<span id="logo"> <img src="{{ base_url }}public/website/configuration/1610705126logo-bawang1.png" style="width:40px" alt="BG Admin">BG Admin</span>
			</div>
			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1 class="txt-color-red login-header-big"><i>Bawang Goreng Admin</i></h1>
						<div class="hero">
