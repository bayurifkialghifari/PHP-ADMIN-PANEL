...
<html lang="en" class="smart-style-2">
	<head>
		<meta charset="utf-8">
		<title>GGWP | {{ $title }}</title>
		<meta name="description" content="GGWP">
		<meta name="author" content="GGWP">
		...
		<!-- #FAVICONS -->
		<link rel="shortcut icon" href="{{ base_url }}public/website/configuration/1610705126logo-bawang1.png" type="image/x-icon">
		<link rel="icon" href="{{ base_url }}public/website/configuration/1610705126logo-bawang1.png" type="image/x-icon">
		<!-- #GOOGLE FONT -->
		...
		<!-- PLUGIN PAGE -->
		@if(isset($plugin) AND count(plugin[$plugin]['scripts']) > 0)
			@foreach(plugin[$plugin]['scripts'] as $scripts)
				<script src="{{ base_url }}{{ $scripts }}"></script>
			@endforeach
		@endif
		<!-- DATATABLE FUNCTION -->
		@if(isset($plugin) AND $plugin == 'datatables')
	...
	<body class="desktop-detected pace-done smart-style-2">
		...
		<header id="header">
			<div id="logo-group">
				...
				<span style="color:white" id="logo"> <img src="{{ base_url }}website/configuration/1610705126logo-bawang1.png" style="width: 30px" alt="Admin">BAWANG GORENG</span>
				...
				<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
					<li class="">
						<a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown"> 
							<img src="{{ base_url }}website/configuration/1610705126logo-bawang1.png" class="online" alt="#">
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it --> 
					...
					<a href="javascript:;" id="show-shortcut" data-action="toggleShortcut">
						<img src="{{ base_url }}website/configuration/1610705126logo-bawang1.png" alt="me" class="online" /> 
						<span>
							USER NAME
						</span>
					</a> 
		...
		<div class="page-footer">
			<div class="row">
				<div class="col-xs-12 col-sm-12">
					<span class="txt-color-white">Copyright © GGWP</span>
				</div>
			</div>
		</div>
		<!-- END PAGE FOOTER -->
